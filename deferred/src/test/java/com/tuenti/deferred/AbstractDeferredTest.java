...
public abstract class AbstractDeferredTest {
	...
	protected DeferredFactory deferredFactory;
	protected FakeExecutorProvider fakeExecutorProvider;
	...
	protected void createDeferredManager() {
		this.deferredManager = new DefaultDeferredManager(fakeExecutorProvider, deferredFactory);
	}
