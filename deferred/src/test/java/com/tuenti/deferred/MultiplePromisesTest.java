...
public class MultiplePromisesTest extends AbstractDeferredTest {
	...
	@Test
	public void testProgressWait() {
		DeferredCallable<Integer, Integer> task1 = new DeferredCallable<Integer, Integer>(fakeExecutorProvider) {
			public Integer call() {
				int sum = 0;
				for (int i = 1; i <= 10; i++) {
					try {
		...
		DeferredRunnable<String> task2 = new DeferredRunnable<String>(fakeExecutorProvider) {
