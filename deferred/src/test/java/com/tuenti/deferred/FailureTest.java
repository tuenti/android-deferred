...
public class FailureTest extends AbstractDeferredTest {
	...
	public void testResolvingTwice() {
		Deferred<Integer, Void, Void> deferred = new DeferredObject<Integer, Void, Void>(fakeExecutorProvider);
	...
	public void testResolvingTwiceInThread() {
		...
		final Deferred<Integer, Void, Void> deferred = new DeferredObject<Integer, Void, Void>(fakeExecutorProvider);
