...
public interface Promise<D, F, P> {
	 ...
	 * @return
	 */
	<F_OUT> Promise<D, F_OUT, P> then(FailFilter<F, F_OUT> failFilter);
	 ...
	 * @return
	 */
	<P_OUT> Promise<D, F, P_OUT> then(ProgressFilter<P, P_OUT> progressFilter);
	 ...
	 * @return
	 */
	<D_OUT, F_OUT, P_OUT> Promise<D_OUT, F_OUT, P_OUT> then(FailPipe<F, D_OUT, F_OUT, P_OUT> failPipe);
	 ...
	 * @return
	 */
	<D_OUT, F_OUT, P_OUT> Promise<D_OUT, F_OUT, P_OUT> then(ProgressPipe<P, D_OUT, F_OUT, P_OUT> progressPipe);
	...
	/**
	 * Removes all callbacks for this promise
	 */
	void ignoreCallbacks();
