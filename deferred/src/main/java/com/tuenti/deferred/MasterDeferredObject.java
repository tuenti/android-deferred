...
class MasterDeferredObject extends DeferredObject<MultipleResults, OneReject, MasterProgress>
	...
	public MasterDeferredObject(ExecutorProvider executorProvider,
			Promise... promises) {
